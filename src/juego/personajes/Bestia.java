...
public class Bestia extends Personaje {
    ...
    public void atacar(Personaje enemigo) {
        ...
        // Lógica específica para un arma con nombre "GarraMay" (ejemplo de bonificación)
        if (this.arma.getNombre().equalsIgnoreCase("GarraMay")) {
            danoTotal += (int)(danoTotal * 0.04); // Añade un +4% de daño extra si es una GarraMay
        }
    ...
    /**
     * Implementación del método sanar para el personaje Bestia.
